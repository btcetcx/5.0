...
const implementedWarehousePaths = [
  ...
  '/storehouse/outbound-management',
  '/storehouse/inbound-management',
  '/storehouse/sorting-delivery',
  '/storehouse/shipping-delivery',
  '/storehouse/sales-orders',
  '/storehouse/incoming-material',
  '/storehouse/inventory-warning',
...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      {
        path: 'settings/:section(system|units|currencies|security|data|integrations)',
      ...
      {
        path: 'storehouse/incoming-material',
        name: 'StorehouseIncomingMaterial',
        component: () => import('@/views/storehouse/StorehouseIncomingMaterial.vue'),
        meta: { title: '来料管理' },
      },
      {
        path: 'storehouse/inventory-warning',
        name: 'StorehouseInventoryWarning',
        component: () => import('@/views/storehouse/StorehouseWarehouseManagement.vue'),
        meta: { title: '库存预警' },
      },
      {
      ...
      },
      {
        ...
        component: () => import('@/views/equipment/EquipmentWorkbench.vue'),
        meta: { title: '设备中心' },
      },
      {
      ...
      {
        path: 'energy/:section(monitor|analysis|reports|saving|carbon|product|department|data|equipment)',
        name: 'EnergyResource',

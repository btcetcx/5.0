...
export const rdDocumentListMockResponse: RdDocumentListResponse = {
  ...
  items: [
    ...
    { id: 'doc_007', code: 'DD-2026-007', name: '边缘控制器调试草案', type: '技术文档', category: '技术规范', state: '草稿', tone: 'blue', version: 'V0.1', owner: '周敏', date: '2026-06-01' },
    { id: 'doc_008', code: 'DD-2026-008', name: '产线看板接口说明', type: '工艺文件', category: '装配指南', state: '已退回', tone: 'yellow', version: 'V0.8', owner: '王凯', date: '2026-06-03' },
    { id: 'doc_009', code: 'DD-2026-009', name: '可靠性测试作业规范', type: '操作规范', category: '安全操作', state: '已驳回', tone: 'gray', version: 'V0.6', owner: '林悦', date: '2026-06-05' },
  ],
};

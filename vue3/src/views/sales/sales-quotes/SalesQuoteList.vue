<template>
  ...
  <aw-setting-modal :open="filterModalOpen" title="报价单筛选" width="560px" @cancel="filterModalOpen = false" @confirm="applyFilterModal">
...
async function handleRefresh() {
  await loadData();
  toolbarMessage.value = `报价单已刷新，共 ${filteredItems.value.length} 条。`;
}

  ...
  <aw-form-page :actions="formActions" back-text="返回计划列表" @back="emit('back')" @action="handleFormAction">
    <section class="aw-form-card">
      ...
      <div class="aw-form-grid">
        ...
        <div class="aw-field"><label class="req">计划开始日期</label><input class="aw-input" type="date" /></div>
        <div class="aw-field"><label class="req">计划结束日期</label><input class="aw-input" type="date" /></div>
        <div class="aw-field">
          <label>统计口径</label>
            ...
            <table class="aw-table">
              ...
              <tbody>
                <tr v-for="row in filteredProductPickerRows" :key="row.productCode" @click="togglePickedProduct(row)">
                  ...
                  <td class="aw-num">{{ row.productCode }}</td><td>{{ row.productName }}</td><td>{{ row.model }}</td><td>{{ row.category }}</td><td>{{ row.unit }}</td><td class="aw-num">{{ row.unitPrice }}</td>
                </tr>
              </tbody>
            </table>
          </div>

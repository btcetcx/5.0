...
function addPreviewAttachment() {
  attachmentRows.value.push({ id: Date.now(), name: '', type: '技术文档', date: '2026-05-30', remark: '' });
}

function addPreviewDetail() {
  editableRows.value.push({ id: Date.now(), product: '新增物品', qty: 1, date: '2026-06-20', remark: '' });
}

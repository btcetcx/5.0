...
export const topNavItems: TopNavItem[] = [
  ...
  },
  {
    ...
    title: 'PRD 中心',
    route: '/prd',
    sideItems: [{ key: 'financePrd', label: '财务中心', route: '/prd' }],
  },
  {
    key: 'rd',
    label: '研发',
        ...
        flyout: [
          {
            title: '采购订单',
            items: [
              { label: '添加采购订单', route: '/purchase/purchase-orders?action=new' },
              { label: '采购订单列表', route: '/purchase/purchase-orders' },
              { label: '已完成采购订单', route: '/purchase/purchase-orders?action=已完成采购订单' },
            ],
          },
          { title: '采购订单设置', items: settingEntries('采购订单', '/purchase/purchase-orders') },
        ],
      },
      {
        key: 'pret',
  ...
  },
  {
    ...
    sideItems: [
      ...
      jsxSideItem('financeSettings', '财务设置', '/finance/settings'),
    ],
  },
  {
    key: 'equipment',
        ...
        flyout: [
          {
            ...
            items: [
              ...
              { label: '维修验收', route: '/equipment/repairs?view=acceptance' },
            ],
          },
          {
            title: '维修设置',

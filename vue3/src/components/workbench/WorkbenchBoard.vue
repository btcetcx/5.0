  ...
  <div class="aw-workbench-board">
    <div class="aw-card">
      <div class="section-title">
        ...
        <button class="aw-card-meta aw-card-meta-btn" type="button" :class="{ refreshing }" @click="refreshTodos">
          <span class="aw-refresh-dot"><AwIcon name="line-refresh" size="13" /></span>
          刷新
        </button>
    ...
    <div class="aw-card">
      ...
      <div class="aw-entry-grid">
        ...
        >
          <div class="aw-entry-icon" :style="{ background: entry.tint, color: entry.color }">
            <AwIcon :name="entry.icon" :label="entry.label" size="18" />
          </div>
          <div class="aw-entry-label">{{ entry.label }}</div>
        </div>
        <div class="aw-entry aw-entry-add">
          <div class="aw-entry-icon"><AwIcon name="line-plus" size="18" /></div>
    ...
    <div class="aw-workbench-feed-grid">
      ...
      <div class="aw-card">
        ...
        <div v-for="item in recent.slice(0, 5)" :key="item.title" class="aw-recent-row">
          <span class="aw-recent-ic"><AwIcon name="workbench-order" :label="item.title" size="17" /></span>
          <div>
        ...
        <div class="body">
          <div class="aw-todo-list">
            <div v-for="item in kpis" :key="item.label" class="aw-todo-row">
              <div class="aw-todo-ic"><AwIcon :name="item.icon" :label="item.label" size="17" /></div>

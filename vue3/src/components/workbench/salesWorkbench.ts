...
export const rdWorkbench = {
  kpis: [
    ...
    { tone: 'mint', label: '待评审项目', value: 4, icon: '▤' },
  ...
  entries: [
    ...
    { label: '新增项目', tint: '#DCE7FB', color: '#5677FC', icon: '▤' },
  ...
  notices: [
    { type: '重要', text: '智能输送线系统研发项目进入阶段评审，请补齐项目描述、物料清单和工艺流程', time: '2小时前', tone: 'aw-feed-tag-rose' },
  ...
  recent: [
    ...
    { title: 'PRJ-2025-001 智能输送线系统研发', meta: '研发 · 项目管理 · 1小时前' },
    { title: 'CP-20260521001 iPhone17', meta: '研发 · 产品管理 · 今天 10:05' },
...
export const qcWorkbench = {
  kpis: [
    { tone: 'sky', label: '当前范围', value: 20, icon: '▣' },
    { tone: 'peach', label: '待处理', value: 9, icon: '✓' },
    { tone: 'rose', label: '异常/不合格', value: 5, icon: '!' },
    { tone: 'mint', label: '已放行/启用', value: 4, icon: '▦' },
    { tone: 'sand', label: '待复检', value: 1, icon: '⇄' },
    { tone: 'lilac', label: '让步审批', value: 1, icon: '◇' },
    { tone: 'rose', label: 'CAPA/8D', value: 1, icon: '□' },
    { tone: 'peach', label: '待审批方案', value: 1, icon: '▤' },
  ],
  tiles: [
    { label: '质检管理', sub: '检验执行', count: 6, tint: '#DCE7FB', color: '#5677FC', icon: '✓' },
    { label: '待检任务', sub: '抽样/判定', count: 4, tint: '#FEF3CD', color: '#B26A24', icon: '▤' },
    { label: 'IQC', sub: '来料检验', count: 2, tint: '#DBF3E6', color: '#10B981', icon: '↓' },
    { label: 'IPQC', sub: '过程检验', count: 2, tint: '#E8DEFB', color: '#8957D8', icon: '▦' },
    { label: 'FQC', sub: '成品检验', count: 1, tint: '#DCE7FB', color: '#5677FC', icon: '▣' },
    { label: 'OQC', sub: '出货检验', count: 1, tint: '#FEF3CD', color: '#B26A24', icon: '↑' },
    { label: '异常处理', sub: 'NCR/CAPA', count: 5, tint: '#FBDFDF', color: '#D14D4D', icon: '!' },
    { label: '质检分析', sub: '趋势/不良', count: 4, tint: '#DBF3E6', color: '#10B981', icon: '⌕' },
    { label: '质检设置', sub: '方案/项目/规则', count: 5, tint: '#E8DEFB', color: '#8957D8', icon: '□' },
  ],
  entries: [
    { label: '新增检验任务', tint: '#DCE7FB', color: '#5677FC', icon: '✓' },
    { label: '检验任务列表', tint: '#DBF3E6', color: '#10B981', icon: '▦' },
    { label: '待检任务', tint: '#FEF3CD', color: '#B26A24', icon: '▤' },
    { label: '不合格记录', tint: '#FBDFDF', color: '#D14D4D', icon: '!' },
    { label: '返工复检', tint: '#E8DEFB', color: '#8957D8', icon: '⇄' },
    { label: '检验方案', tint: '#DCE7FB', color: '#5677FC', icon: '□' },
    { label: '质量趋势', tint: '#DBF3E6', color: '#10B981', icon: '⌕' },
  ],
  notices: [
    { type: '重要', text: 'IQC 到货批次与仓储入库已同步，请先完成抽样和判定再回写上架数量', time: '30分钟前', tone: 'aw-feed-tag-rose' },
    { type: '系统', text: '生产报工待质检、IPQC 返工复检和 FQC 入库放行规则已纳入质检联动', time: '2小时前', tone: 'aw-feed-tag-mint' },
    { type: '审批', text: '让步放行和缺陷等级判定表待质量经理确认，审批通过后同步更新标准版本', time: '今天 09:20', tone: 'aw-feed-tag-peach' },
    { type: '公告', text: '质检自定义字段、编号、审批、策略和打印模板已按客户设置母版配置', time: '昨天 17:30', tone: 'aw-feed-tag-sky' },
  ],
  recent: [
